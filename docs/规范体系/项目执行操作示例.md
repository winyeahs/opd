...
graph TB
    ...
    style State fill:#ECFDF5,stroke:#059669
    style Data fill:#FEF3C7,stroke:#D97706
    style C1 fill:#fff,stroke:#4F46E5
    style C2 fill:#fff,stroke:#4F46E5
    style C3 fill:#fff,stroke:#4F46E5
    style C4 fill:#fff,stroke:#4F46E5
    style C5 fill:#fff,stroke:#4F46E5
    style C6 fill:#fff,stroke:#4F46E5
    style S1 fill:#fff,stroke:#059669
    style D1 fill:#fff,stroke:#D97706
```
...
graph TB
    ...
    style Public fill:#EEF2FF,stroke:#4F46E5
    style Src fill:#EEF2FF,stroke:#4F46E5
    style Components fill:#ECFDF5,stroke:#059669
    style Stores fill:#ECFDF5,stroke:#059669
    style Utils fill:#ECFDF5,stroke:#059669
    style PackageJson fill:#FEF3C7,stroke:#D97706
    style ViteConfig fill:#FEF3C7,stroke:#D97706
    style TailwindConfig fill:#FEF3C7,stroke:#D97706
```
